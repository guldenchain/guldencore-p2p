 ...
 * using the standard Gulden protocol. A Peer instance represents one connection
 * on the Gulden network. To create a new peer connection provide the host and port
